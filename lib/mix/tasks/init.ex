defmodule Mix.Tasks.Oauth2Server.Init do
  ...
  def create_oauth_tables() do
    ...
    create_oauth_refresh_tokens_query = "CREATE TABLE IF NOT EXISTS oauth_refresh_tokens (id bigint(20) unsigned NOT NULL AUTO_INCREMENT, oauth_client_id bigint(20) unsigned NOT NULL, user_id bigint(20) unsigned NOT NULL, token varchar(255) DEFAULT NULL, expires_at int(11) NOT NULL, INDEX IDX_1CF73D31A76ED395 (oauth_client_id), INDEX IDX_1CF73D3144F5D008 (user_id), PRIMARY KEY (id), FOREIGN KEY (oauth_client_id) REFERENCES oauth_clients(id), FOREIGN KEY (user_id) REFERENCES users(id))"
